...
user_investment_period: Medium-term (weeks to months,
user_execution_preferences: (User-defined, e.g., Preferred broker is IBKR,
preference for limit orders over market orders, with a trailing stop, desire for low latency but still with cost optimization,
